...
<nav class="navbar navbar-expand-sm bg-light navbar-light">
  ...
  <div class="form-group">
    ...
    <input type="test" class="form-control" name="schedule_name" placeholder="Example: Sunday's schedule" required>
  </div>
  <div class="form-group">
      <br>
            ...
            <div class="dropdown">
                ...
                <br>
                    <label for="class'.$i.'">Class'.$i.'</label>
                        <select class="btn btn-secondary dropdown-toggle" type="button" name="class'.$i.'" data-bs-toggle="dropdown" aria-expanded="false" required>
 ...
 ?>
 <br>
  <input type="submit" value="Create Schedule" class="btn-outline-lg">
</form>
<!--</div>-->
</body>
